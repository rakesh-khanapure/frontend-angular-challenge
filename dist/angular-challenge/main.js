...
const routes = [
    { path: '', component: _home_home_component__WEBPACK_IMPORTED_MODULE_2__["HomeComponent"], canActivate: [_helpers__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
...
let AppComponent = class AppComponent {
    constructor(router, authenticationService) {
        ...
        this.title = 'The HRS Angular Coding Challenge';
    ...
    intercept(request, next) {
        ...
        function updateUser() {
            if (!isLoggedIn())
                return unauthorized();
            const user = body;
            const editAtIndex = users.findIndex(x => x.id === user.id);
            users[editAtIndex].firstName = body.firstName;
            users[editAtIndex].lastName = body.lastName;
            users[editAtIndex].updateDate = new Date().toUTCString();
            localStorage.setItem('users', JSON.stringify(users));
            return ok();
        }
        // helper functions
...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password) {
        return this.http.post(`${this.user.apiUrl}/users/authenticate`, { username, password })
...
let UserService = class UserService {
    ...
    update(user) {
        const updatePayload = { id: user.id, firstName: user.firstName, lastName: user.lastName };
        return this.http.put(`${this.apiUrl}/users/${user.id}`, updatePayload);
    }
};
...
module.exports = __webpack_require__(/*! /Users/rkhanapure/Documents/frontend-angular-challenge/src/main.ts */"./src/main.ts");
